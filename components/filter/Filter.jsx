          ...
          <Modal.Body>
            ...
            <View className="divide-y">
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">Only show in stock items</Text>
                <Switch
              ...
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">Only show items on sale</Text>
                <Switch
